...
```js
import { FxPicker, FxPickerPopup, FxPickerView } from 'rfox'
```
...
<<< @/../../rfox-demo/src/components/Form/Picker/index.tsx
...
<<< @/../../rfox-demo/src/components/Form/PickerPopup/index.tsx
...
<<< @/../../rfox-demo/src/components/Form/PickerView/index.tsx
